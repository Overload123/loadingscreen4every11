<?php
	...
	*/
	...
	$default_map = 'rp_downtown_v4c'; // Default map if you're viewing in browser
	...
	$enable_cycle_colours = true; // Enable cycling background colours? (true / false) If this isn't working please empty $bg_img (Default: false)
